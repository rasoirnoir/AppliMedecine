...
public class TestAssoAdresse {
	...
	public static void main(String[] args) {
		...
		Patient hillary = new Patient("Vambuce", "Hillary", "0123456789", Patient.Sexe.F, 287060244010154l,
				LocalDate.of(1987, 6, 2), "Allergie aux arachides", comp);
		Patient ines = new Patient("Perret", "Inès", "0698745123", Patient.Sexe.F, 245021067034521l, LocalDate.of(1945, 2, 10),
				null, nio);
		Patient adhemar = new Patient("Pamamobe", "Adhémar", "0753428619", Patient.Sexe.M, 192112192020142l,
